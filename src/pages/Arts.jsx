  ...
  const subcategories = [
    {
      ...
      path: "/arts/sketching",
      emoji: "✏️",
      description: "Premium sketching tools and paper",
    },
    {
      name: "Painting",
      path: "/arts/painting",
      emoji: "🎨",
      description: "Quality paints, brushes, and canvases",
    },
    {
      name: "Abstract",
      path: "/arts/abstract",
      emoji: "🖼️",
      description: "Modern abstract art supplies",
    },
  ];
    ...
    <div className="min-h-screen py-12 px-4 lg:px-20">
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          ...
          >
            Discover art supplies for every creative vision
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {subcategories.map((category, index) => (
            ...
            >
              <Link
                to={category.path}
                className="block rounded-[24px] bg-gradient-to-br from-[#FFF6F8]/90 to-[#C8B6E2]/90 backdrop-blur-sm border-2 border-[#7A6C9D]/30 p-8 shadow-xl hover:shadow-2xl transition-all duration-300 group"
              >
