...
export function Embroidery() {
  ...
  const embroideryProducts = useMemo(() => {
    const filtered = products.filter((p) => p.type?.toLowerCase() === "embroidery");
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <motion.div className="text-center mb-16">
          ...
          <p className="text-xl text-[#FFF6F8]">
            Elegant embroidery materials for stunning projects
          </p>
          {isSeller && (
        ...
        {/* 🔥 Fixed: was rendering stale `filtered`, now renders sorted `embroideryProducts` */}
        {embroideryProducts.length > 0 ? (
          ...
          <div className="text-center py-20">
            <span className="text-2xl" style={{ fontFamily: "Pacifico, cursive", color: "#FF8FA3", textShadow: "0 0 30px rgba(255, 143, 163, 0.6)" }}>
              No embroidery products available yet.
            </span>
          </div>
        )}
      </div>
